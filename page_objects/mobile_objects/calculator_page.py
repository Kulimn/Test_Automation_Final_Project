...
amount = (By.XPATH, "//*[@id='etAmount']")
term = (By.XPATH, "//*[@id='etTerm']")
rate = (By.XPATH, "//*[@id='etRate']")
calculate = (By.XPATH, "//*[@id='add_schedule_text']")
save = (By.XPATH, "//*[@id='btnSave']")
repayment = (By.XPATH, "//*[@id='tvRepayment']")
interest = (By.XPATH, "//*[@id='tvInterestOnly']")
